...
export const speciesMapping: SpeciesMap = {
  ...
  [Species.Feline]: [
    ...
    'meow',
    'lombax',
    '(exotic|domestic|british|oriental|american|shaded|chinchilla)[ -]?shorthair',
    'burmese',
    'maine[ -]?coon',
    'korat',
    'ragdoll',
