<template>
  <div>
    <div
      ...
      :style="position"
      v-if="character"
      style="position: fixed; padding: 10px 10px 5px; display: block; width: 220px; z-index: 1100"
      ref="menu"
    >
...
<script lang="ts">
  ...
  export default class UserMenu extends Vue {
    ...
    setBookmarked(): void {
      core.connection
        .queryApi(`bookmark-${this.character!.isBookmarked ? 'remove' : 'add'}.php`, { name: this.character!.name })
